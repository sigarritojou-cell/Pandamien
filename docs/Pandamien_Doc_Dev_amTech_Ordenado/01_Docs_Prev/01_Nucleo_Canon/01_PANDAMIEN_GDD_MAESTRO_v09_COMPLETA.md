...
## Versión ultra consolidada v09 de visión, sistemas, narrativa, entorno, auditoría y prebuild
...
Este documento sustituye al GDD maestro v08 como **versión maestra de trabajo**. Su función sigue siendo consolidar en una única fuente:
...
- la Oleada 5 expandida más allá de su primer bloque material,
- la Oleada 6 abierta con un bloque authored estructural fuerte de confrontación final,
- la Oleada 7 abierta y operativa mediante auditoría, control de voces, variables, assets, cruce transversal y corte MVP,
- y, desde esta versión, el **paquete canónico de prebuild** que traduce el corpus previo a orden real de implementación.

Este documento no cierra todavía cada línea exacta del juego ni cada detalle final de implementación. Sí cierra la base necesaria para producir el proyecto sin contradicciones graves y, desde esta versión, deja alineado el maestro con el nuevo estado de:
- **backlog real de implementación**,
- **tabla de features MVP**,
- **lista de assets P0/P1 por disciplina**,
- **mapa de dependencias entre sistemas**,
- **primer sprint plan de implementación**,
- y **Anexo R — Paquete canónico de prebuild e implementación MVP**.
...
2. Se conserva como canon cerrado la capa literaria explícita y la continuidad relacional.
3. Se mantiene el reconocimiento de authored cubriendo **Ciclos 1–8**.
4. Se mantiene el reconocimiento de la **Oleada 5** como bloque material, televisivo, exterior y de criatura ya musculado.
5. Se mantiene el reconocimiento de la **Oleada 6** como bloque authored estructural de confrontación final ya producido.
6. Se mantiene la **Oleada 7** como abierta y operativa.
7. Se consolida el nuevo paquete canónico de prebuild:
   - backlog real,
   - features MVP,
   - assets P0/P1 por disciplina,
   - mapa de dependencias,
   - sprint plan,
   - y Anexo R.
8. Se reajusta la prioridad inmediata: ya no consolidar más, sino **arrancar Sprint 00** o, como mucho, hacer una última revisión de carpeta previa.
...
- orden canónico de prebuild.

## 36.2. En desarrollo
- normalización fina del corpus satélite **C / D / E** bajo la **Biblia de diálogos** y el **Diccionario unificado de variables**,
- ejecución real del backlog de implementación,
- puesta en marcha de Sprint 00,
- build MVP del apartamento, la TV, el umbral, la criatura y el final,
...
## 36.2.5. Cerrado como paquete canónico de prebuild
- Backlog real de implementación v01.
- Tabla de features MVP v01.
- Lista de assets P0/P1 por disciplina v01.
- Mapa de dependencias entre sistemas v01.
- Primer sprint plan de implementación v01.
- Anexo R — Paquete canónico de prebuild e implementación MVP v01.

## 36.2.6. Estado por oleadas
...
- Oleada 5: activa y musculada, con bloque material, televisivo, exterior y de criatura producidos y assets P0/P1 ya priorizados.
- Oleada 6: activa y muy avanzada, con confrontación final ya bajada a perfiles, verbos, cierres, staging, escenas maestras, árbol base, nodos, pseudológica y paquete MVP.
- Oleada 7: abierta, operativa y ya consolidada en una primera pasada completa, con traducción a prebuild y backlog real de implementación.

## 36.2.7. Regla operativa de archivo satélite
...
## 36.3. Abierto
- ejecución real de Sprint 00 y sucesivos,
- validación de pipeline de authored a runtime,
- vertical slice interno estable,
- y pulido del build MVP.
...
- Pendiente: variantes finas de build y expansión post-MVP.
...
## Anexo R — Paquete canónico de prebuild
Activo.
- **R — Paquete canónico de prebuild e implementación MVP v01**.
- Consolida backlog, features, assets, dependencias y sprint plan como núcleo previo de implementación.
- Debe incluirse en la carpeta de documentación previa del proyecto.
...
La escritura, consolidación y planificación del contenido no se hará por acumulación caótica de escenas. Se hará por oleadas coordinadas, con validación cruzada entre narrativa, sistemas, entorno, arte, sonido, QA y producción. Ninguna oleada se considera cerrada hasta que el Arquitecto/a de Documentación y Versionado Canónico actualice el GDD maestro, los anexos afectados y el changelog correspondiente.
...
7. Ninguna expansión nueva tiene prioridad sobre normalización, backlog real y montaje de MVP.
8. Una vez consolidado el paquete de prebuild, el siguiente paso sano es ejecutar sprint, no abrir otra biblia gorda.
...
### Célula 5 — Normalización, QA y build
Responsables:
- Producción
- Arquitecto/a de Documentación y Versionado Canónico
- Sistemas
...
- y ejecución de sprints de implementación.
...
- sonido de puerta,
- eventos de umbral,
- biblioteca de TV por fase,
- banco de fenómenos del exterior,
- presencia física y lógica de criatura,
- gramática visible de deterioro,
- traducción espacial por acto y ciclo.

Estado:
- Activa y ampliamente musculada.
- Bloques ya producidos: **J**, **K**, **O**, **F**, **G**, **H**.
- Pendiente: implementación P0/P1 y expansión prudente post-MVP.
...
- Pendiente: implementación del paquete MVP y expansión post-MVP.

## 41.10. Oleada 7 — Auditoría total y prebuild
Objetivo:
- comprobar que canon, variables, anexos, assets, nomenclatura, staging y alcance final no se contradicen, y traducir esa limpieza a orden real de implementación.
...
- mapa de dependencias,
- sprint plan,
- paquete canónico de prebuild.

Estado:
- Abierta y operativa.
- Bloques ya producidos: **B**, **Q**, **Q.2**, **Q.3**, **Q.4**, **Q.5**, **Backlog v01**, **Features MVP v01**, **Assets P0/P1 v01**, **Dependencias v01**, **Sprint Plan v01**, **R**.
- Pendiente: ejecución de Sprint 00 y siguientes.

## 41.11. Prioridad inmediata tras esta versión
1. Congelar carpeta de documentación previa con el paquete canónico de prebuild.
2. Arrancar **Sprint 00**:
   - contrato de datos,
   - IDs,
   - save base,
   - debug,
   - limpieza C/D/E bajo B y Q.4.
3. Preparar el paso a **Sprint 01** con layout, interacción y puerta.
4. Mantener una regla de hierro:
   - no abrir expansión nueva antes de tener slice interno estable.
