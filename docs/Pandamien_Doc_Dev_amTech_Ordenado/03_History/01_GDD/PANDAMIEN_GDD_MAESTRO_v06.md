...
## Versión ultra consolidada v06 de visión, sistemas, narrativa, entorno y producción
...
- y, desde esta versión, el **estado consolidado del trabajo authored hasta el Ciclo 8**, con la **Oleada 4 ya cerrada en base authored**, la **Oleada 5 ya iniciada con un primer bloque operativo real** y un protocolo explícito para trabajar con **archivo satélite** sin romper el canon.

Este documento no cierra todavía cada línea de diálogo ni cada escena final exacta. Sí cierra la base necesaria para producir el juego sin contradicciones graves y, desde esta versión, deja alineado el estado del maestro con el trabajo real ya levantado tanto en fuentes activas como en anexos authored archivados fuera de ellas.
...
4. Se declara la **Oleada 3** como cerrada, la **Oleada 4** como cerrada en base authored y la **Oleada 5** como ya iniciada con un primer bloque operativo real de atlas, props, gramática material de puerta/deterioro y banco de umbrales/exterioridad.
5. Se actualiza el estado de anexos para distinguir entre:
   - anexos canónicos de columna vertebral en fuentes activas,
   - anexos authored ya producidos,
   - y anexos authored que pueden conservarse en **archivo satélite** cuando las fuentes activas no admitan más documentos.
6. Se activa como bloque operativo de Oleada 5 el primer paquete material del apartamento y del borde: **Anexo J** en su capa de atlas y props, **Anexo K** en su capa de gramática material y **Anexo O** como banco base de umbrales/exterioridad.
7. Se mantiene abierta la confrontación final exacta, pero ya con una base verbal, anatómica, espacial y de historial mucho más sólida para diseñarla.
8. Se reajusta la prioridad inmediata: consolidar el arranque real de la **Oleada 5**, abrir la **biblioteca de líneas TV**, abrir el **diseño detallado de criatura** y preparar el marco authored de la **confrontación final**.
...
- banco completo y graduado de fenómenos de exterior,
- atlas artístico y espacial del deterioro en su cobertura completa por actos, ciclos y zonas,
- gramática exacta de confrontación final y cierres,
- biblia de diálogos por registros y familias de voz,
- diseño detallado de criatura y presencia corporal máxima,
...
## 36.2.2. Cerrado como primer bloque operativo de Oleada 5
...
- Oleada 5: activa, con primer bloque operativo ya producido y pendiente de expansión transversal.
- Oleada 6: pendiente de diseño authored completo, pero ya con suelo material suficiente para abrirse.
- Oleada 7: no iniciada.

## 36.2.4. Regla operativa de archivo satélite
...
- proporción final entre presencia directa y eco contaminado de ciertos vínculos,
- integración exacta entre atlas artístico, gramática de puerta, biblioteca TV y diálogo final.
...
Pendiente.
- Debe abrirse como apoyo transversal entre Oleada 5 y Oleada 6.
...
Pendiente.
- Prioridad alta inmediata tras esta consolidación.
- Debe coordinarse con la Oleada 5 y servir de puente directo hacia la Oleada 6.

## Anexo G — Banco de fenómenos del exterior
Pendiente.
- Parte de su base funcional ha sido anticipada por el **Anexo O**, pero falta su versión completa y graduada por actos/ciclos.
- Prioridad alta dentro de la expansión de Oleada 5.

## Anexo H — Diseño detallado de la criatura
Pendiente.
- Debe coordinarse con Oleada 5 y Oleada 6.
...
Entregables:
- tabla de 8 ciclos con presencia base, presión activa y eco parasitario,
- foco de contaminación principal y secundario por ciclo,
- contención principal disponible por ciclo,
- función anatómica dominante de la criatura por ciclo,
- evento de TV dominante,
- evento exterior dominante,
- señal de puerta dominante,
- verdad emocional del ciclo.

Criterio de cierre:
- cada ciclo debe poder resumirse sin contradicciones entre sistema, narrativa y entorno.
...
Entregables:
- fichas completas de madre, amigo, editor y pareja/ex,
- cadencia por ciclo y por formato,
- subtexto cotidiano,
- distorsión alucinada,
- zonas que tiñen,
- funciones de criatura que pueden alimentar,
- temas que puede robar la TV.

Criterio de cierre:
- ningún personaje principal puede sentirse episódico o ornamental.
...
- ficha de noche,
- ficha de cierre,
- persistencia para el ciclo siguiente,
- mapa de cadencia relacional de ese día.

Criterio de cierre:
- cada ciclo debe explicar claramente qué presiona, qué se contamina, qué puede contenerse y qué vuelve por la noche.
...
Entregables:
- nodos por personaje,
- nodos de reaparición,
- nodos de insistencia,
- nodos de ausencia significativa,
- nodos de eco contaminado,
- efectos sobre variables,
- locks/unlocks,
- ecos en TV, noche y exterior.

Criterio de cierre:
- cada árbol debe sostener tono, variación, coherencia y función sistémica.

## 41.8. Oleada 5 — Atlas artístico y espacial del deterioro
Objetivo:
- sincronizar arte y diseño con el estado real del sistema.

Entregables:
- estados visuales del piso por ciclo,
- props,
- gramática sonora y material de puerta por ciclo,
- eventos de mirilla, ventana y balcón,
- guías de presencia corporal de la criatura,
- banco de umbrales y fenómenos exteriores con valor de producción.

Estado actual:
- abierta y ya iniciada con un primer bloque operativo: atlas base, props prioritarios, gramática material de puerta/deterioro y banco base de umbrales/exterioridad.

Criterio de cierre:
- ningún elemento visual o sonoro importante puede quedar “bonito pero huérfano”.

## 41.9. Oleada 6 — Confrontación final y cierres
Objetivo:
- cerrar la gramática del enfrentamiento dialogado con la criatura.

Entregables:
- tipos de aproximación del jugador,
- estados de sociabilidad/agresividad/imitación/súplica de la criatura,
- nodos finales condicionados por historial,
- posibles resoluciones compatibles con el canon.

Criterio de cierre:
- la confrontación final debe sentirse como devolución del historial, no como escena ajena al resto del juego.

## 41.10. Oleada 7 — Auditoría total de canon y producción
Objetivo:
- consolidar un corpus listo para vertical slice ampliado y luego juego cerrado.

Entregables:
- revisión de nomenclatura,
- revisión de variables,
- revisión de ecos cruzados,
- revisión de asset list,
- revisión de alcance,
- actualización final de anexos y changelog.

Criterio de cierre:
- todo cambio importante debe estar trazado y ninguna parte del sistema puede depender de memoria oral.

## 41.11. Estado actual por oleadas
- Oleada 1: cerrada.
- Oleada 2: cerrada en versión base authored.
- Oleada 3: cerrada, con cobertura authored de ciclos 1–8 en día/noche.
- Oleada 4: cerrada en base authored, con árboles y ecos de ciclos 1–8.
- Oleada 5: activa, con primer bloque operativo ya producido.
- Oleada 6: pendiente de diseño authored completo, pero lista para preapertura metodológica.
- Oleada 7: pendiente.

## 41.12. Orden de ejecución recomendado
1. Oleada 1
2. Oleada 2
3. Oleada 3
4. Oleada 4
...
## 41.13. Prioridad inmediata tras esta actualización
Con la **Oleada 5** ya iniciada en un primer bloque operativo real y con los anexos **J**, **K** y **O** ya sembrados, el siguiente trabajo sano debe centrarse en:

- consolidar en canon documental el arranque real de la **Oleada 5**,
- abrir el **Anexo F — Biblioteca de líneas TV por fase**,
- abrir el **Anexo G — Banco de fenómenos del exterior** en versión amplia y graduada,
- abrir el **Anexo H — Diseño detallado de la criatura**,
- y dejar preparado el primer documento marco authored de la **Oleada 6 — Confrontación final**.

La regla práctica a partir de aquí es clara: el proyecto ya no necesita más columna vertebral authored por ciclos; necesita **cuerpo material y gramática final**. La siguiente ganancia real no vendrá de abrir más árboles de ciclo, sino de convertir el historial ya escrito en estados del piso, props, sonidos, umbrales, presencia corporal, biblioteca verbal de TV y lenguaje de confrontación.
...
**el piso recuerda, el jugador elige qué dejar pudrirse, y eso acaba respirando, mirando, contestando y exigiendo forma al otro lado de una puerta.**
