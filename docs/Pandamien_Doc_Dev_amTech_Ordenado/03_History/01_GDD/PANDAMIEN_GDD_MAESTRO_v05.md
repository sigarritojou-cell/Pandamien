...
## Versión ultra consolidada v05 de visión, sistemas, narrativa, entorno y producción
...
- y, desde esta versión, el **estado consolidado del trabajo authored hasta el Ciclo 8**, con la **Oleada 4 ya cerrada en base authored**, la **Oleada 5 formalmente abierta** y un protocolo explícito para trabajar con **archivo satélite** sin romper el canon.
...
4. Se declara la **Oleada 3** como cerrada y la **Oleada 4** como cerrada en base authored, quedando la **Oleada 5** abierta formalmente como siguiente frente principal.
...
6. Se mantiene abierta la confrontación final exacta, pero ya con una base verbal, anatómica y de historial mucho más sólida para diseñarla.
7. Se reajusta la prioridad inmediata: abrir el **Atlas artístico y espacial del deterioro**, preparar el aterrizaje material de criatura/puerta y empezar el marco authored de la **confrontación final**.
...
- atlas artístico y espacial del deterioro,
...
- Oleada 5: abierta formalmente como bloque canónico principal.
- Oleada 6: abierta sólo a nivel de principios, no de diseño final authored.
- Oleada 7: no iniciada.

## 36.2.3. Regla operativa de archivo satélite
...
- integración exacta entre atlas artístico, gramática de puerta y diálogo final.
...
Pendiente.
- Prioridad alta dentro de la Oleada 5.
...
Pendiente.
- Debe abrirse como frente principal dentro de la Oleada 5.

## Anexo K — Manual de contaminación por zonas y contención
Pendiente.
- Debe actualizarse en paralelo al atlas artístico y espacial.
...
- props,
- gramática sonora de puerta por ciclo,
- eventos de mirilla, ventana y balcón,
- primeras guías de presencia corporal de la criatura.
...
- Oleada 5: abierta formalmente.
- Oleada 6: pendiente de diseño authored completo.
- Oleada 7: pendiente.
...
Con el trabajo authored ya consolidado de **Ciclos 1–8** en los anexos **C**, **D** y **E**, y con la base sistémica de **A**, **I** y **M** ya operativa, el siguiente trabajo sano debe centrarse en:

- abrir el **Atlas artístico y espacial del deterioro** por ciclos y por actos,
- abrir el **Anexo J — Apartamento canónico detallado**,
- abrir el **Anexo F — Biblioteca de líneas TV por fase**,
- abrir el **Anexo G — Banco de fenómenos del exterior**,
- fijar la **gramática sonora/material de la puerta** por tramos,
- preparar el **Anexo H — Diseño detallado de la criatura**,
- y dejar listo el suelo para la **Oleada 6 — Confrontación final**.

La regla práctica a partir de aquí es clara: el proyecto ya no necesita más columna vertebral authored por ciclos; necesita **cuerpo material**. La siguiente ganancia real no vendrá de abrir otro árbol, sino de convertir el historial ya escrito en estados del piso, props, sonidos, umbrales, presencia corporal y lenguaje final de confrontación.
