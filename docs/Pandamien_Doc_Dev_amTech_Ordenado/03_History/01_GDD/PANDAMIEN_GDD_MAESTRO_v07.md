...
## Versión ultra consolidada v07 de visión, sistemas, narrativa, entorno y producción
...
- y, desde esta versión, el **estado consolidado del trabajo authored hasta el Ciclo 8**, con la **Oleada 5 ya expandida más allá de su primer bloque material** y la **Oleada 6 ya abierta con un bloque authored estructural fuerte de confrontación final**, manteniendo además un protocolo explícito para trabajar con **archivo satélite** sin romper el canon.

Este documento no cierra todavía cada línea exacta del juego ni cada detalle final de implementación. Sí cierra la base necesaria para producir el proyecto sin contradicciones graves y, desde esta versión, deja alineado el estado del maestro con el trabajo real ya levantado tanto en fuentes activas como en anexos authored archivados fuera de ellas.
...
4. Se declara que la **Oleada 5** ya no se sostiene sólo en su primer bloque material, sino también en una expansión authored y sistémica clara mediante **Anexo F**, **Anexo G** y **Anexo H**.
5. Se declara que la **Oleada 6** ya no está sólo preabierta metodológicamente: dispone de un bloque authored estructural completo de confrontación final mediante **Anexo P** y los subanexos **P.1–P.8**.
6. Se actualiza el estado de anexos para distinguir entre:
   - anexos canónicos de columna vertebral en fuentes activas,
   - anexos operativos ya producidos,
   - y anexos authored que pueden conservarse en **archivo satélite** cuando las fuentes activas no admitan más documentos.
7. Se mantiene abierta la confrontación final exacta en su capa más fina de implementación y pulido, pero ya con:
   - perfiles,
   - verbos,
   - cierres,
   - staging,
   ...
   - árbol base,
   - banco de nodos,
   - y pseudológica de selección.
8. Se reajusta la prioridad inmediata: consolidar documentalmente este nuevo estado, abrir la **Biblia de diálogos** como apoyo transversal, cruzar de forma fina **TV / exterior / criatura / confrontación** con los ciclos authored ya cerrados y preparar la futura **Oleada 7 — Auditoría total**.
...
## 36.2. En desarrollo
- transiciones y cierres authored por ciclo como capa unificada de revisión final,
- biblia de diálogos por registros y familias de voz,
- expansión completa del atlas artístico y espacial por actos, ciclos y zonas,
- asset map final para vertical slice ampliado y juego cerrado,
- implementación fina de confrontación final, variantes definitivas y test transversal,
- corporalidad máxima de la criatura en su capa más visible y espectacularmente controlada,
- normalización definitiva entre authored granular, anexos satélite y paquete de build.
...
- Oleada 5: activa y ya ampliamente musculada, con bloque material, televisivo, exterior y de criatura producidos en base operativa.
- Oleada 6: activa y muy avanzada en su bloque authored estructural, con confrontación final ya bajada a perfiles, verbos, cierres, staging, escenas maestras, árbol base y pseudológica.
- Oleada 7: no iniciada como auditoría formal, pero ya preparada como siguiente frente sano tras esta consolidación.

## 36.2.5. Regla operativa de archivo satélite
...
## 36.3. Abierto
- confrontación final exacta en su versión definitiva de build,
- número definitivo de finales o subvariantes visibles al jugador,
- priorización exacta de finales para MVP frente a juego completo,
- capa máxima de corporalidad visible de la criatura,
- integración exacta entre atlas artístico, gramática de puerta, biblioteca TV, banco de exterioridad y paquete final de escenas,
- asset map y orden final de implementación para vertical slice ampliado y juego cerrado.
...
Pendiente.
- Pasa a prioridad alta como apoyo transversal entre la expansión de Oleada 5 y el authored fino de Oleada 6.
- Debe servir para normalizar registros, familias de voz y limpieza final de redundancias entre escenas, árboles y confrontación.
...
- Pendiente: revisión transversal final de continuidad y limpieza de redundancias.

## Anexo D — Fichas de ciclos día por día
Activo.
- Fichas reales cerradas: **Ciclos 1–8 — Día**.
- Puede residir en **archivo satélite authored**.
- Pendiente: capa global de transición/cierre y normalización final.
...
- Pendiente: expansión fina por formatos, cadenas, ritmos y reutilización controlada en build final.

## Anexo G — Banco de fenómenos del exterior
Activo.
- Versión base amplia y graduada cerrada: **v01**.
- Complementa al **Anexo O** y lo expande.
...
- Este bloque puede residir total o parcialmente en **archivo satélite authored** siempre que maestro, plan y changelog reflejen su estado.
- Pendiente: líneas definitivas de build, variantes finales seleccionadas para MVP y auditoría transversal.
...
- Pendiente: cruce fino con ciclos authored, expansión completa por actos/ciclos/zonas y asset map final.
...
- Pendiente: selección definitiva de variantes MVP, pulido fino de líneas, test de diferencias entre partidas y cierre de build final.

## 41.10. Oleada 7 — Auditoría total
Objetivo:
- comprobar que canon, variables, anexos, assets, nomenclatura, staging y alcance final no se contradicen.
...
- revisión de assets,
- revisión de alcance,
- paquete de implementación consolidado,
- changelog final de auditoría.

Estado:
- No iniciada formalmente.
- Ya preparada como siguiente frente sano tras esta consolidación.

## 41.11. Prioridad inmediata tras esta versión
1. Consolidar en canon el bloque ya producido de **Oleada 5** y **Oleada 6**.
2. Abrir **Anexo B — Biblia de diálogos** como capa transversal de registros y familias de voz.
3. Hacer cruce fino entre:
   - **F / G / H / P–P.8**
   - y los ciclos authored ya cerrados en **C / D / E**.
4. Preparar un primer **paquete de implementación MVP** del final:
   - perfiles prioritarios,
   - cierres prioritarios,
   - rutas mínimas de build.
5. Abrir la **Oleada 7 — Auditoría total**.
