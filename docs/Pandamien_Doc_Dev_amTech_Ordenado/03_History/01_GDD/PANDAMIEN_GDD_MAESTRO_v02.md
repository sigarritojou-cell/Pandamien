...
## Versión ultra consolidada v02 de visión, sistemas, narrativa, entorno y producción
...
- y, desde esta versión, una **lectura literaria y experiencial explícita** del proyecto y una **cadencia relacional continua** entre los vínculos principales.
...
2. Se añade una capa literaria explícita para fijar qué significa el juego en profundidad y cómo debe sentirse.
3. Se sustituye el enfoque implícito de “personaje dominante por ciclo” por un modelo de **presencia continua + picos de presión + ecos persistentes**.
4. Se redefine la función de los ciclos para que organicen la escalada dramática sin compartimentar artificialmente las relaciones.
5. Se incorpora un **plan de acción por oleadas** dentro del propio GDD para guion, sistemas cruzados, arte, continuidad y producción.
...
El siguiente trabajo operativo debe centrarse en:
- cerrar el **Anexo M — Mapa de cadencia relacional por ciclos**,
- cerrar el **Anexo D — Fichas de ciclos día por día**,
- y cerrar el **Anexo E — Fichas de noches**.

Sin esas tres piezas, el guion puede crecer bonito pero fofo. Con ellas, el castillo ya tiene estructura de carga.
