...
## Versión ultra consolidada v08 de visión, sistemas, narrativa, entorno, auditoría y producción
...
Este documento sustituye al GDD maestro v07 como **versión maestra de trabajo**. Su función sigue siendo consolidar en una única fuente:
...
- un sistema de documentación/versionado para evitar pérdida de información entre versiones,
- la **lectura literaria y experiencial explícita** del proyecto,
- la **cadencia relacional continua** entre los vínculos principales,
- el **estado consolidado del trabajo authored hasta el Ciclo 8**,
- la **Oleada 5** ya expandida más allá de su primer bloque material,
- la **Oleada 6** ya abierta con un bloque authored estructural fuerte de confrontación final,
- y, desde esta versión, la **Oleada 7** ya abierta y operativa mediante una primera pasada integral de auditoría documental.

Este documento no cierra todavía cada línea exacta del juego ni cada detalle final de implementación. Sí cierra la base necesaria para producir el proyecto sin contradicciones graves y, desde esta versión, deja alineado el maestro no sólo con el trabajo authored previo, sino también con el nuevo estado de:
- **Biblia de diálogos**,
- **diccionario de variables y nomenclatura**,
- **matriz de cruce transversal por ciclos**,
- **asset map priorizado**,
- y **paquete MVP del final**.

### Cambios estructurales introducidos en esta actualización
1. Se mantiene intacta la lógica central de puerta atrancada, contaminación por zonas, contención parcial y criatura gestada.
2. Se conservan como canon cerrado la capa literaria explícita y la continuidad relacional.
3. Se consolida que el desarrollo authored ya cubre **Ciclos 1–8** en fichas de día, fichas de noche y árboles de diálogo.
4. Se mantiene la declaración de que la **Oleada 5** ya no se sostiene sólo en su primer bloque material, sino también en una expansión authored y sistémica clara mediante **Anexo F**, **Anexo G** y **Anexo H**.
5. Se mantiene la declaración de que la **Oleada 6** ya no está sólo preabierta metodológicamente: dispone de un bloque authored estructural completo de confrontación final mediante **Anexo P** y los subanexos **P.1–P.8**.
6. Se declara oficialmente que la **Oleada 7** ya no está pendiente de apertura: queda **abierta y operativa** mediante **Anexo Q**, **Anexo B**, **Anexo Q.2**, **Anexo Q.3**, **Anexo Q.4** y **Anexo Q.5**.
7. Se añade a canon una capa transversal de control de voces y registros mediante **Anexo B**.
8. Se fija una convención oficial de variables y nomenclatura mediante **Anexo Q.4**.
9. Se consolida que el proyecto ya dispone de:
   - una lectura transversal por ciclos de **TV / exterior / criatura / confrontación final**,
   - un **asset map priorizado**,
   - y un **paquete MVP del final**.
10. Se reajusta la prioridad inmediata: dejar de expandir a ciegas, normalizar authored satélite, traducir auditoría a backlog real y preparar build MVP controlado.
...
## 4.6. Lectura literaria, simbólica y experiencial

### 4.6.1. El apartamento como cámara de amplificación moral
PANDAMIEN no trata sólo del encierro físico. Trata del modo en que el encierro convierte cada gesto pequeño en un eco desproporcionado. En condiciones normales, una llamada ignorada, una bolsa sin tirar, una conversación pospuesta o una tarde anestesiada por la televisión podrían disiparse en el ruido del mundo. Aquí no. Aquí el apartamento actúa como una cámara de resonancia ética y emocional: todo permanece, todo sedimenta, todo vuelve.

### 4.6.2. La criatura como inventario orgánico de lo no atendido
La criatura no representa un mal externo autónomo. Es el cuerpo progresivo de la deuda. No es castigo sobrenatural ni metáfora abstracta despegada de la mecánica. Es una consecuencia íntima hecha carne. Cada zona descuidada, cada foco no contenido, cada evitación sostenida y cada sustitución de cuidado por anestesia contribuyen a darle funciones, presencia, temperamento y lenguaje. El monstruo es, literalmente, una biografía de omisiones.

### 4.6.3. La puerta atrancada como promesa de sentido
La puerta sellada no funciona sólo como misterio. Funciona como promesa. Es el lugar donde el juego guarda lo que todavía no quiere explicar del todo. Al principio pertenece al orden doméstico: madera hinchada, marco deformado, reparación pendiente. Después pasa a ser el umbral donde el jugador proyecta lo que teme. Más tarde se convierte en prueba física de que el piso recuerda. Y al final deja de ser sólo puerta: es el lugar donde una vida aplazada exige ser mirada.

### 4.6.4. La contención como liturgia precaria
Las acciones de limpieza o contención no deben sentirse como mantenimiento del hogar, sino como pequeños rituales de resistencia. Rascar moho, ventilar una zona, retirar una bolsa que gotea o arrancar una tela húmeda son gestos humildes, casi ridículos, pero cargados de tensión moral. El jugador nunca salva el piso: a lo sumo decide qué parte de la podredumbre está dispuesto a retrasar y cuál va a dejar crecer.

### 4.6.5. El horror como intimidad deformada
El juego no busca el sobresalto, sino la perversión de lo cercano. Lo que aterra no es que haya “algo” en casa, sino que ese algo sepa demasiado del protagonista. La amenaza gana forma a partir de hábitos, vínculos, tonos de voz, cansancio, cuerpo, vergüenza y rutinas. Por eso la criatura puede llegar a ser razonable, agresiva, suplicante o imitativa: no nace con una personalidad cerrada, sino que aprende del clima humano que la ha gestado.

### 4.6.6. La televisión, la ventana y la mirilla como aparatos de mediación rota
El juego trabaja con dispositivos que prometen conectar y en realidad deforman. La TV acompaña, narcotiza, editorializa y parasita. La ventana deja ver un afuera que nunca termina de verificarse. La mirilla ofrece proximidad sin contexto. Entre las tres construyen una experiencia donde el jugador nunca recibe realidad limpia, sólo versiones, reflejos, sesgos y retornos contaminados de su propia ansiedad.

### 4.6.7. Lo que puede significar para el jugador
PANDAMIEN puede operar como experiencia de culpa, de duelo, de depresión funcional, de hipervigilancia, de saturación mediática, de bloqueo íntimo o de desgaste cotidiano. No obliga a una única lectura clínica ni moral. Lo importante es que el jugador sienta que el juego le devuelve algo incómodo pero reconocible: la idea de que no siempre destruimos las cosas con violencia; a veces las deformamos por aplazamiento, por cansancio, por cobardía suave, por dejarlas para mañana.

### 4.6.8. La confrontación final como devolución ética de la palabra
Si el final culmina en diálogo con la criatura, ese diálogo no debe vivirse como conversación expositiva ni como negociación con un monstruo clásico. Debe sentirse como una devolución. El jugador se enfrenta a una forma de vida que habla con las palabras, silencios, ritmos y maneras de tratar al mundo que él mismo ha cultivado. La criatura será tan sociable, razonable, manipuladora o violenta como haya sido el historial del jugador con sus vínculos, su piso y sus umbrales.

### 4.6.9. Principio literario final
El piso no está maldito: está saturado. La criatura no invade: coagula. Y el horror no llega de fuera: termina de organizarse dentro.
...
1. **Día dentro del apartamento**
   ...
   - continuidad relacional variable entre vínculos principales.
...
2. **Transición**
   ...
   - quedan en suspensión conversaciones, no-respuestas y decisiones del día.
...
3. **Noche**
   ...
   - retorno distorsionado de lo relacional acumulado.
...
5. **Persistencia**
   ...
   - y cambia la cadencia con que ciertos vínculos vuelven a irrumpir.

## 5.1.1. Regla de continuidad vincular
Los ciclos organizan la presión dramática, pero no aíslan a los personajes en compartimentos cerrados. Los vínculos principales deben poder respirar a lo largo de todo el juego mediante presencia directa, eco diegético, relectura, insistencia, ausencia significativa o parasitación por parte de la TV y la criatura.
...
- instalación de madre y amigo como presencias continuas,
...
- entra con más peso la pareja/ex o la herida íntima.
...
### Regla previa
Cada ciclo tiene:
- **presencia base**: vínculos que pueden aparecer de forma cotidiana aunque no sean el foco principal,
- **presión activa**: vínculo o sistema que más aprieta ese ciclo,
- **eco parasitario**: voces o relaciones que quizá no aparecen de forma directa, pero sí contaminan TV, noche, puerta o exterior.

Esto evita un modelo rígido de “un personaje por ciclo” y conserva, a la vez, una escalada dramática clara.

### Ciclo 1 — Reconocimiento
- se establece rutina,
- se presenta puerta atrancada como detalle cotidiano,
- el jugador conoce la base relacional del encierro,
- madre y amigo pueden aparecer ya como continuidad cotidiana,
- el editor se instala como deuda inicial,
...
- madre y amigo siguen presentes como fondo vivo,
- el editor aprieta más o reaparece con una exigencia concreta,
- puede sembrarse la primera aparición leve de la pareja/ex,
- una zona ligada al trabajo se ensucia o densifica,
- se introduce primera contención simple,
- la criatura gana un primer rasgo funcional más legible.

### Ciclo 3 — El cuerpo entra en juego
- madre/medicación ganan peso,
- baño y dormitorio ganan centralidad,
- la pareja/ex puede empezar a entrar ya en el tejido diario,
- proliferan humedad, cansancio y descuido,
- el editor puede seguir como deuda latente,
- la puerta reacciona con respiración o roce.

### Ciclo 4 — La herida íntima
- la pareja/ex toma la presión activa,
- dormitorio y balcón se contaminan por intimidad suspendida,
- madre y amigo siguen pudiendo irrumpir,
- el editor no desaparece, pero pasa a eco o amenaza de fondo,
- la criatura gana corazón, pecho o voz emocional.

### Ciclo 5 — El exterior se pega al piso
- mirilla, paquete, sombra, rellano y luces vecinas ganan peso,
- una zona de umbral se pudre,
- madre y amigo siguen entrando como continuidad realista,
- el editor puede reaparecer con otro deadline,
- la pareja/ex deja ecos en dormitorio, balcón o TV,
- la criatura gana ojos o atención dirigida.

### Ciclo 6 — Colonización semántica
- todos los vínculos pueden estar ya presentes de forma directa o parasitaria,
- la TV roba lenguaje de todos,
- la contaminación ya es cruzada,
- la criatura puede emitir frases, ritmos o masticaciones reconocibles,
- el jugador empieza a sentir que las relaciones no avanzan por líneas separadas, sino por fusión.

### Ciclo 7 — Doble vínculo imposible
- dos presiones incompatibles se superponen,
- ya no hay modo de sostenerlo todo,
- el jugador sacrifica una parte del piso, un vínculo o una verdad,
- la madre, el editor, la pareja/ex, el amigo o el exterior pueden chocar en combinaciones distintas,
- la puerta aguanta a duras penas,
- se fija con más fuerza el temperamento dominante de la criatura.
...
- la confrontación con la criatura devuelve una mezcla de todos los vínculos,
- el final debe leerse como culminación del historial, no como escena aislada.
...
## 10.4.1. Cadencia base recomendada
- **Madre**: presencia diaria o casi diaria; puede variar entre llamada, mensaje, nota de voz, insistencia o eco clínico.
- **Amigo**: presencia muy frecuente; mensajes cortos, audios, banalidad, chistes, compañía o ruido evasivo.
- **Editor**: presencia puntual pero pesada; inicio, deadlines, recordatorios o reproches estratégicos.
- **Pareja / Ex**: entrada progresiva a partir del segundo o tercer ciclo; después puede volverse recurrente, ambigua o intermitente según estado relacional.
...
## 10.8. Regla de variación de formato
Cada vínculo principal debe cambiar de formato a lo largo del juego. No basta con repetir el mismo tipo de escena. Un personaje puede reaparecer como llamada, mensaje, audio, silencio, insistencia, historial releído, eco de TV, recuerdo o imitación nocturna.
...
## 11.5. Modelo canónico de continuidad vincular
El juego no se organizará como un reparto donde cada personaje domina un día y desaparece del mapa. A partir de esta versión, las relaciones siguen un modelo de:
...
### Presencia continua
El vínculo puede aparecer de manera cotidiana aunque ese ciclo no sea “suyo”.

### Pico de presión
En determinados ciclos, un vínculo o sistema aprieta más y tiñe la decisión central, la contaminación principal o el eco nocturno.

### Eco persistente
Aunque no haya aparición directa, el vínculo puede seguir vivo como llamada perdida, mensaje releído, voz robada por la TV, evento nocturno, objeto, recuerdo o deformación de la criatura.

## 11.6. Cadencia relacional base por vínculo

### Madre
- frecuencia alta,
- idealmente diaria o casi diaria,
- asociada a baño, dormitorio, medicación, cuerpo, sueño y culpa filial,
- su insistencia puede mutar de cuidado a control sin necesidad de una escena grande cada vez.

### Amigo
- frecuencia alta,
- idealmente diaria o muy frecuente,
- asociado a salón, cocina, banalidad, ruido, compañía y evasión,
- puede ser importante precisamente por no “parecer importante”.

### Editor
- frecuencia baja-media,
- presencia espaciada pero de alto peso,
- asociado a trabajo, horarios, deuda, utilidad, rendimiento y vergüenza funcional,
- conviene reservar sus irrupciones para hitos con verdadera presión.

### Pareja / Ex
- entrada gradual,
- si es posible, empieza a notarse a partir del ciclo 2 o 3,
- asociado a dormitorio, balcón, memoria, intimidad y herida suspendida,
- su reaparición debe sentirse como una invasión del refugio, no como una tarea más del día.

## 11.7. Reglas de presencia
1. Ningún vínculo principal desaparece por completo más de dos ciclos seguidos sin dejar rastro directo o indirecto.
2. Madre y amigo funcionan como ritmos de continuidad del encierro.
3. Editor y pareja/ex funcionan mejor como presencias de golpe, retorno o reactivación.
4. La TV y la criatura pueden conservar vivos vínculos ausentes mediante parasitación.
5. La repetición debe variar en tono, formato, urgencia y consecuencia para no volverse patrón vacío.

## 11.8. Función espacial y anatómica de la continuidad relacional
La continuidad vincular no es sólo narrativa. Debe afectar:
- qué zonas se tiñen más a menudo,
- qué focos de contaminación reaparecen,
- qué voces roba la TV,
- qué funciones gana la criatura,
- y qué tipo de diálogo final será posible con ella.

## 11.9. Regla de cierre
La confrontación final con la criatura debe poder leerse como suma deformada de todos los vínculos sostenidos o abandonados, no como revancha aislada de un solo personaje.
...
## 22.4. Regla de convivencia de troncos
Los troncos no deben presentarse como capítulos cerrados e independientes. Deben coexistir, cruzarse, rebotarse y contaminarse. La estructura por ciclos sirve para ordenar qué tronco o sistema ejerce la **presión activa** en un momento dado, no para apagar artificialmente el resto.

## 22.5. Prioridad productiva
Para escritura y producción, cada ciclo debe especificar:
- qué troncos están en presencia base,
- cuál ejerce presión activa,
- cuáles sobreviven como eco parasitario,
- y cómo se traduce eso a foco de contaminación, TV, exterior y puerta.
...
## 23.1.1. Regla de triple función
Ningún nodo importante debe existir sólo para “desarrollar personaje”. Todo nodo relevante debe mover, como mínimo, dos de estas tres capas, y lo ideal es que toque las tres:
- vínculo,
- apartamento,
- criatura/puerta.
...
## 23.2.1. Tipos de recurrencia relacional
Además de los nodos “principales”, el sistema de diálogo debe contemplar:
- nodo de reaparición,
- nodo de seguimiento,
- nodo de insistencia,
- nodo de ausencia significativa,
- nodo de historial releído,
- nodo de eco contaminado.
...
location_bias: ""
related_zone: ""
recurrence_type: "main / followup / insistence / absence_echo / reread / contaminated_echo"
player_options:
  - option_id: ""
    label: ""
...
## 23.5. Regla de continuidad
Las ramas de diálogo deben prever que un vínculo pueda volver de forma menor aunque ese ciclo no esté centrado en él. El guion no se escribirá como ocho bloques aislados, sino como un tejido de insistencias, ausencias, variaciones de tono y reapariciones.
...
- estado de puerta,
- ritmo emocional,
- y cadencia relacional acumulada.
...
- y capas de continuidad vincular.

## 24.4. Regla de cadencia relacional aplicada a eventos
El sistema debe distinguir entre:
- **evento de rutina**: continuidad diaria o frecuente,
- **evento de presión**: hito fuerte del ciclo,
- **evento de eco**: persistencia indirecta.

Esto permite que la madre o el amigo sigan vivos sin convertir cada día en una escena grande, y que el editor o la pareja/ex tengan irrupciones más medidas y memorables.
...
- y prueba clara de **continuidad relacional**: al menos un vínculo frecuente, uno de presión puntual y uno de eco persistente.
...
- madre y amigo como continuidad mínima,
- editor o pareja/ex como presión puntual significativa.
...
- continuidad relacional sostenida de principio a fin.
...
- compartimentar las relaciones en bloques artificiales y perder la sensación de vida cotidiana.
...
- y escribir escenas “bonitas” que no alteren ni vínculo, ni piso, ni criatura.
...
- y mala gestión de recurrencias relacionales entre presencia directa, ecos y reapariciones.
...
- continuidad relacional como principio estructural,
- lectura literaria y experiencial del proyecto,
- no IA en runtime,
- necesidad de control documental/versionado.

## 36.2. En desarrollo
- normalización fina del corpus satélite **C / D / E** bajo la **Biblia de diálogos** y el **Diccionario unificado de variables**,
- traducción de auditoría a backlog real de implementación,
- selección de build del **MVP**,
- pulido authored fino de rutas MVP del final,
- corporalidad máxima visible de la criatura en sus variantes no prioritarias,
- expansión no esencial de assets P1/P2 según capacidad real de producción.

## 36.2.1. Cerrado como bloque operativo y authored de base
- Anexo A — Biblia de personajes v01.
- Anexo M — mapa de cadencia relacional por ciclos v01.
- Anexo I — tabla ampliada de efectos cruzados v01.
- Anexo D — fichas reales de día de los ciclos 1–8.
- Anexo E — fichas reales de noche de los ciclos 1–8.
- Anexo C — árboles de diálogo y ecos authored de los ciclos 1–8.

## 36.2.2. Cerrado como bloque operativo de Oleada 5
- Anexo J — Atlas artístico y espacial del deterioro v01.
- Anexo J — Catálogo de props narrativos prioritarios v01.
- Anexo K — Gramática material de puerta, deterioro visible y contención v01.
- Anexo O — Banco base de umbrales, fenómenos exteriores y eventos de borde v01.
- Anexo F — Biblioteca de líneas TV por fase v01.
- Anexo G — Banco ampliado de fenómenos del exterior v01.
- Anexo H — Diseño detallado de la criatura v01.

## 36.2.3. Cerrado como bloque authored estructural de Oleada 6
- Anexo P — Marco authored de la confrontación final v01.
- Anexo P.1 — Matriz de perfiles de confrontación final v02.
- Anexo P.2 — Verbos y respuestas authored de confrontación v01.
- Anexo P.3 — Cierres authored compatibles v01.
- Anexo P.4 — Staging, imágenes finales y líneas de cierre v01.
- Anexo P.5 — Escenas maestras authored de confrontación final v01.
- Anexo P.6 — Árbol authored base de confrontación final v01.
- Anexo P.7 — Banco de nodos finales y líneas exactas v01.
- Anexo P.8 — Locks, condiciones y pseudológica de implementación final v01.

## 36.2.4. Cerrado como bloque operativo inicial de Oleada 7
- Anexo B — Biblia de diálogos, registros y familias de voz v01.
- Anexo Q — Auditoría total de canon, variables, assets y alcance v01.
- Anexo Q.2 — Asset map y prioridades de producción v01.
- Anexo Q.3 — Paquete MVP del final v01.
- Anexo Q.4 — Diccionario unificado de variables y nomenclatura v01.
- Anexo Q.5 — Matriz de cruce transversal por ciclos v01.

## 36.2.5. Estado por oleadas
- Oleada 1: cerrada en versión operativa base.
- Oleada 2: cerrada en versión base authored.
- Oleada 3: cerrada, con ciclos 1–8 ya bajados a día/noche.
- Oleada 4: cerrada en base authored, con ciclos 1–8 cubiertos en árboles y ecos.
- Oleada 5: activa y ya ampliamente musculada, con bloque material, televisivo, exterior y de criatura producidos en base operativa y priorización de assets ya abierta.
- Oleada 6: activa y muy avanzada en su bloque authored estructural, con confrontación final ya bajada a perfiles, verbos, cierres, staging, escenas maestras, árbol base, nodos y pseudológica, y con paquete MVP ya seleccionado.
- Oleada 7: abierta y operativa, con primera pasada integral de auditoría ya producida y pendiente de traducción a backlog real y consolidación de build.

## 36.2.6. Regla operativa de archivo satélite
Cuando las fuentes activas del proyecto no admitan más documentos, los anexos authored granulares podrán conservarse en **archivo satélite** siempre que:
- el **GDD Maestro** refleje con precisión su existencia y estado,
- el **Changelog canónico** registre la consolidación correspondiente,
- el **Plan de oleadas** no quede desalineado,
- y ningún anexo satélite contradiga la fuente maestra.

## 36.3. Abierto
- normalización fina del corpus authored satélite,
- backlog y orden de build reales,
- implementación de assets P0/P1,
- vertical slice final con rutas MVP del cierre,
- y pulido definitivo de la confrontación final en su versión de build.
...
## 37.5. Regla de archivo satélite
Cuando el proyecto no pueda albergar más archivos en sus fuentes activas, el corpus puede dividirse en:

- **fuente activa mínima canónica**,
- y **archivo satélite authored**.

### Fuente activa mínima canónica recomendada
- GDD Maestro vigente,
- Changelog canónico vigente,
- Plan de oleadas vigente,
- Anexo A — Biblia de personajes,
- Anexo I — Tabla ampliada de efectos cruzados,
- Anexo M — Cadencia relacional.

### Archivo satélite authored recomendado
- Anexo C por ciclos,
- Anexo D por ciclos,
- Anexo E por ciclos,
- y otros desarrollos granulares que no necesiten contexto permanente en la fuente activa.

### Regla de validez
El archivo satélite es válido para producción siempre que el maestro, el changelog y el plan recojan fielmente su estado. El problema no es que un anexo esté fuera de la fuente activa; el problema es que el canon vivo no lo refleje.
...
## Anexo A — Biblia de personajes
Activo.
- Versión base authored cerrada: **v01**.
- Recomendado en fuente activa mínima canónica.

## Anexo B — Biblia de diálogos
Activo.
- Versión base operativa cerrada: **v01**.
- Funciona como capa transversal de registros, familias de voz, contaminación verbal y control de tono.
- Debe usarse para normalizar **C / D / E** y afinar **F / H / P.7**.

## Anexo C — Árboles de diálogo y ecos por ciclo
Activo.
- Árboles authored cerrados: **Ciclos 1–8**.
- Puede residir en **archivo satélite authored** si la fuente activa no admite más documentos.
- Pendiente: revisión transversal final de continuidad, tono y limpieza de redundancias bajo B y Q.4.

## Anexo D — Fichas de ciclos día por día
Activo.
- Fichas reales cerradas: **Ciclos 1–8 — Día**.
- Puede residir en **archivo satélite authored**.
- Pendiente: normalización final de variables, tono y transiciones.

## Anexo E — Fichas de noches
Activo.
- Fichas reales cerradas: **Ciclos 1–8 — Noche**.
- Puede residir en **archivo satélite authored**.
- Pendiente: normalización final y cruce con atlas artístico/sonoro.

## Anexo F — Biblioteca de líneas TV por fase
Activo.
- Versión base operativa cerrada: **v01**.
- Pendiente: expansión fina por formatos, ritmos y reutilización controlada en build final.

## Anexo G — Banco de fenómenos del exterior
Activo.
- Versión base amplia y graduada cerrada: **v01**.
- Pendiente: cruce fino con pacing, sonido y asset map definitivo.

## Anexo H — Diseño detallado de la criatura
Activo.
- Versión base operativa cerrada: **v01**.
- Conecta Oleada 5 con Oleada 6 y fija variables, reglas de creación, perfiles y escalabilidad.
- Pendiente: afinado de corporalidad máxima visible e implementación fina.
...
## Anexo J — Atlas artístico y espacial del deterioro
Activo.
- Atlas base v01 operativo.
- Catálogo de props narrativos prioritarios v01 operativo.
- Puede residir parcial o totalmente en archivo satélite si la fuente activa no admite más documentos.
- Pendiente: expansión completa por actos, ciclos, materiales, iluminación y lectura espacial.

## Anexo K — Gramática material de puerta, deterioro visible y contención
Activo.
- Versión base v01 operativa.
- Debe seguir desarrollándose en paralelo al atlas artístico y al diseño detallado de criatura.

## Anexo L — Changelog canónico
Activo.
- Documento de control obligatorio.

## Anexo M — Mapa de cadencia relacional por ciclos
Activo.
- Documento operativo cerrado en versión base **v01**.
- Recomendado en fuente activa mínima canónica.

## Anexo N — Plan maestro de oleadas y producción de contenido
Activo.
- Consolidado como plan de ejecución vigente.

## Anexo O — Banco base de umbrales, fenómenos exteriores y eventos de borde
Activo.
- Versión base v01 operativa.
- Complementa y anticipa el futuro Anexo G sin sustituirlo.
- Puede residir en archivo satélite si la fuente activa no admite más documentos.

## Anexo P — Bloque de confrontación final
Activo.
- **P — Marco authored de la confrontación final v01**.
- **P.1 — Matriz de perfiles de confrontación final v02**.
- **P.2 — Verbos y respuestas authored de confrontación v01**.
- **P.3 — Cierres authored compatibles v01**.
- **P.4 — Staging, imágenes finales y líneas de cierre v01**.
- **P.5 — Escenas maestras authored de confrontación final v01**.
- **P.6 — Árbol authored base de confrontación final v01**.
- **P.7 — Banco de nodos finales y líneas exactas v01**.
- **P.8 — Locks, condiciones y pseudológica de implementación final v01**.
- Puede residir total o parcialmente en **archivo satélite authored** siempre que maestro, plan y changelog reflejen su estado.
- Pendiente: líneas definitivas de build, variantes finales seleccionadas para MVP y test final de diferencias entre partidas.

## Anexo Q — Auditoría total
Activo.
- **Q — Auditoría total de canon, variables, assets y alcance v01**.
- **Q.2 — Asset map y prioridades de producción v01**.
- **Q.3 — Paquete MVP del final v01**.
- **Q.4 — Diccionario unificado de variables y nomenclatura v01**.
- **Q.5 — Matriz de cruce transversal por ciclos v01**.
- Este bloque fija la transición de corpus amplio a selección de build.
- Pendiente: traducción de auditoría a backlog real y segunda pasada breve de control antes de vertical slice final.
...
- fragmenta las relaciones en escenas sin continuidad vital,
- o introduce sistemas que no dialogan con culpa, evitación, contaminación y cuerpo.

La regla final del proyecto es sencilla:

**el piso recuerda, el jugador elige qué dejar pudrirse, los vínculos no dejan nunca de presionar del todo, y eso acaba respirando al otro lado de una puerta.**


# 41. Plan de acción maestro — oleadas, entregables y reglas de cierre

## 41.1. Principio general
La escritura y planificación del contenido no se hará por acumulación caótica de escenas. Se hará por oleadas coordinadas, con validación cruzada entre narrativa, sistemas, entorno, arte, sonido y producción. Ninguna oleada se considera cerrada hasta que el Arquitecto/a de Documentación y Versionado Canónico actualice el GDD maestro, los anexos afectados y el changelog correspondiente.

## 41.2. Reglas maestras del plan
1. Nada se escribe fuera de plantilla.
2. Ningún diálogo importante entra en canon si no altera relación, espacio o criatura.
3. Ningún activo artístico relevante se aprueba sin estado sistémico asociado.
4. Ninguna escena nocturna existe sin relación trazable con historial diurno.
5. Ningún cambio de ritmo relacional se hace sin revisar sus ecos en TV, contaminación, puerta y confrontación final.
6. Ningún bloque authored granular puede darse por “cerrado” si no deja trazabilidad suficiente para build, test y consolidación canónica.
7. Tras la auditoría, ninguna expansión nueva tendrá prioridad sobre normalización, selección MVP y backlog real de build.

## 41.3. Células de trabajo

### Célula 1 — Narrativa sistémica
Responsables:
- Arquitectura Narrativa
- Diseño de Sistemas
- Diseñadora de Narrativa Sistémica
...
Encargo:
- matriz madre de contenido,
- efectos cruzados,
- reglas por ciclo,
- consistencia causal entre decisiones y criatura.

### Célula 2 — Voces y relaciones
Responsables:
- Lead Writer
- Guionista de Diálogos
- Diseñadora de Relaciones
...
Encargo:
- biblias de personajes,
- cadencia relacional,
- subtexto,
- tonos de voz,
- ecos y parasitación,
- normalización transversal bajo Anexo B.

### Célula 3 — Piso, exterior y utilería narrativa
Responsables:
- Diseño de Entorno
- Dirección de Arquitectura Espacial
- Lead de Props Narrativos
...
Encargo:
- estados del apartamento,
- props,
- microeventos de umbral,
- manifestaciones materiales de contaminación y presencia,
- priorización P0/P1 de assets.

### Célula 4 — Criatura y confrontación
Responsables:
- Diseñador/a de Presencia Antagónica
- Dirección de Experiencia
- Ingeniería de Gameplay
...
- gramática de puerta,
- manifestaciones por anatomía,
- estructura del diálogo final,
- rutas MVP de build.

### Célula 5 — Normalización y build
Responsables:
- Producción
- Arquitecto/a de Documentación y Versionado Canónico
- Sistemas
...
Encargo:
- traducción de auditoría a backlog,
- limpieza de nomenclatura,
- orden de montaje,
- control de creep,
- validación de selección MVP.

## 41.4. Oleada 1 — Matriz madre de contenido
Objetivo:
- fijar la lógica maestra de los 8 ciclos sin compartimentar los vínculos.

Estado:
- Cerrada en base canónica.

## 41.5. Oleada 2 — Biblias de continuidad vincular
Objetivo:
- definir cómo viven los personajes a lo largo de todo el juego.

Estado:
- Cerrada en base authored inicial con Anexo A.

## 41.6. Oleada 3 — Fichas maestras de ciclos día/noche
Objetivo:
- bajar cada ciclo a una estructura jugable cerrada.

Estado:
- Cerrada, con ciclos 1–8 ya bajados a día y noche.

## 41.7. Oleada 4 — Árboles de diálogo, decisiones y ecos
Objetivo:
- escribir el guion authored real.

Estado:
- Cerrada en base authored, con ciclos 1–8 cubiertos.
- Pendiente a futuro: revisión transversal fina durante normalización de build.

## 41.8. Oleada 5 — Atlas artístico, exterioridad, TV y criatura
Objetivo:
- fijar la capa espacial, material, mediática y anatómica que vuelve legible el apartamento como cuerpo del juego.

Entregables:
- estados del piso,
- props,
- sonido y gramática de puerta,
- banco de umbrales,
- biblioteca de líneas TV,
- banco de fenómenos del exterior,
- diseño detallado de criatura,
- cruces entre apartamento, borde, TV y funciones de criatura.

Estado:
- Activa y ampliamente musculada.
- Bloques ya producidos: **J**, **K**, **O**, **F**, **G**, **H**.
- Pendiente: integración fina con ciclos, cierre de assets **P0 / P1**, y traducción del asset map a orden de producción real.

## 41.9. Oleada 6 — Confrontación final
Objetivo:
- convertir el historial completo de la partida en trato final, cierre y consecuencia espacial.

Entregables:
- marco authored,
- perfiles de confrontación,
- verbos y respuestas,
- familias de cierre,
- staging e imágenes finales,
- escenas maestras,
- árbol base,
- banco de nodos y líneas,
- locks y pseudológica de implementación.

Estado:
- Activa y muy avanzada en base estructural.
- Bloques ya producidos: **P**, **P.1**, **P.2**, **P.3**, **P.4**, **P.5**, **P.6**, **P.7**, **P.8**.
- Pendiente: implementación priorizada del paquete MVP, pulido fino de líneas y test de diferencias entre partidas.

## 41.10. Oleada 7 — Auditoría total
Objetivo:
- comprobar que canon, variables, anexos, assets, nomenclatura, staging y alcance final no se contradicen y traducir esa limpieza a build.
...
- matriz transversal por ciclos,
- asset map,
- paquete MVP del final,
- backlog de implementación consolidado.

Estado:
- Abierta y operativa.
- Bloques ya producidos: **B**, **Q**, **Q.2**, **Q.3**, **Q.4**, **Q.5**.
- Pendiente: traducción a backlog real, validación de selección y segunda pasada breve de control antes de fijar vertical slice final.

## 41.11. Prioridad inmediata tras esta versión
1. Normalizar authored satélite de **C / D / E** usando:
   - **Anexo B**
   - **Anexo Q.4**
2. Traducir **Q.2** y **Q.3** a:
   - backlog real,
   - lista de features MVP,
   - rutas de build prioritarias,
   - lista de assets P0 / P1.
3. Definir el primer paquete de implementación:
   - apartamento P0,
   - TV P0,
   - puerta P0,
   - exterioridad P0,
   - criatura MVP,
   - final MVP.
4. Hacer una revisión breve de control antes de fijar vertical slice final o build fuerte.
